    ...
    internal sealed class SuspensionManager
    {
        ...
        public static async Task SaveAsync()
        {
            try
            {
                ...
                StorageFile file =
                    await
                        ApplicationData.Current.LocalFolder.CreateFileAsync(SESSION_STATE_FILENAME,
        ...
        public static void RegisterFrame( Frame frame,  String sessionStateKey)
        {
            ...
            if (sessionStateKey == null) throw new ArgumentNullException("sessionStateKey");
        ...
        public static async Task RestoreAsync()
        {
            ...
            try
            {
                ...
                StorageFile file = await ApplicationData.Current.LocalFolder.GetFileAsync(SESSION_STATE_FILENAME);
